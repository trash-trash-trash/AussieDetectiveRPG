...
public class Character : MonoBehaviour
{
	...
	private bool IsPathClear(Vector3 targetPos)
    {
		...
		if (Physics2D.BoxCast(transform.position + dir, new Vector2(0.3f, 0.3f), 0f, dir, diff.magnitude - 1, GameLayers.i.SolidLayer | GameLayers.i.InteractableLayer | GameLayers.i.PlayerLayer) == true)
		{
			return false;
		}
		else
